...
public class MapDemoTest {
        ...
        for (;iterator.hasNext();){
            ...
            findTicket.pnrNo="789311815150000";
            ...
            for (; ticketIterator.hasNext();){
                ...
                if (tt.equals(findTicket)){
                    System.out.println("find the ticket"+tt.pnrNo);
                    break;
                }
            ...
            System.out.println(" find the ticket from map " +  mapTicket.pnrNo);
